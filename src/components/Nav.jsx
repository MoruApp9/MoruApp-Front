            ...
            currentUser.userRole === "adminCommerce" ? null : (
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 25"
                  fill="none"
                  className="fill-white hover:fill-current hover:fill-purple-300"
                >
          ...
          <li className="flex flex-col text-xl gap-10 items-start ml-12 mt-9 whitespace-nowrap w-52">
            ...
            <Link to="/support">
              <ul
                ...
                className={`flex items-center space-x-4 mr-3 justify-start p-2 hover:text-purple-moru hover:bg-gray-200 transition-all duration-200 ease-in-out transition-all duration-300 ease-in-out rounded-md w-52 ${

    ...
    return (
        <div>
            ...
            <div className="mt-4 mb-8">
                ...
                <h1>Mōru App nace en 2019 de la necesidad de simplificar la búsqueda, compra y comparación de productos.</h1>
            </div>
            <div className="mt-4 mb-8">
            ...
            <div className="mt-4 mb-8">
                <h1 className="italic bg-gray-100">¿Cuál es su eslogan?</h1>

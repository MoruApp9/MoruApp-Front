      ...
      <div className={`${openMenu ? 'w-72' : 'w-0'} bg-white min-h-screen fixed top-0 left-0 right-0 transition-all duration-300`}>
        <div className={`${!openMenu && 'hidden'} pt-4`}>
          ...
          <li className="flex flex-col space-y-10 text-xl">
            ...
            <ul className="flex justify-center space-x-4"><img className="w-7" src={favIcon} alt="fav" /><Link to="#">Favoritos</Link></ul>
            <ul className="flex justify-center space-x-4"><img className="w-7" src={publishIcon} alt="publish" /><Link to="#">Publicar</Link></ul>
            <ul className="flex justify-center space-x-4"><img className="w-7" src={countIcon} alt="count" /><Link to="#">Cuenta</Link></ul>
            <ul className="flex justify-center space-x-4"><img className="w-7" src={supportIcon} alt="publish" /><Link to="#">Soporte</Link></ul>
          </li>
        </div>
      </div>
    </nav>

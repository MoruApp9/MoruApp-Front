    ...
    return (
        <div className='grid gap-4 max-w-7xl mx-auto font-roboto-slab'>
                ...
                <div className='mx-auto w-full md:w-3/4 lg:w-1/2'>
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center max-w-7xl pt-4 px-8'>
                        <div className='flex items-center'>
                            <h1 className='text-3xl font-bold text-purple-moru'>{branchData.alias}</h1>
                        </div>
            ...
            <span className='ml-1'>Editar nombre</span>
                    ...
                    <div>
                        <h1 className='text-xl md:text-2xl text-gray-800 mt-4'>Dirección: {branchData.address}</h1>
                    </div>
                    <div>
                        <h1 className='text-xl md:text-2xl text-gray-800'>Horario: {branchData.schedule}</h1>
                    </div>
                    <div>
